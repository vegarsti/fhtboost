...
seed <- 10
  ...
  loss_intercept <- cbind(loss_intercept, result_continually$loss)
  loss_no_intercept <- cbind(loss_intercept, result$loss)
  maximum_likelihoods[seed] <- maximum_likelihood
