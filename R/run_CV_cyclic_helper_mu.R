...
run_CV_cyclic_helper_mu <- function(M_fixed, M, K_fold_repetitions, K, X, Z, times, delta, boost_intercepts_continually=boost_intercepts_continually) {
  # M_fixed does not vary; it corresponds to genes and thus y0
  # M varies; corresponds to clinical and thus mu
